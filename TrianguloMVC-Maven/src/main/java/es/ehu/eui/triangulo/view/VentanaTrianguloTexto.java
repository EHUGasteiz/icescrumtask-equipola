...
public class VentanaTrianguloTexto extends JFrame  {
	...
	public VentanaTrianguloTexto(TrianguloRectangulo pTriangulo) {
		initialize();
		modelo = pTriangulo;
		// TODO: aplicar el patron observer y hacer que reaccione a los cambios en el estado de TrainguloRectangulo
		// Posteriormente descomentar el método update y las llamadas que se realizan al mismo
	}
