...
public class VentanaTrianguloCompleta extends JFrame  {
	...
	public VentanaTrianguloCompleta(TrianguloRectangulo pTriangulo) {
		initialize();
		modelo = pTriangulo;
		// TODO: Modificar la clase para que aplique el patron observador y reaccione a los cambios del estado de TrianguloRectangulo
		// Posteriormente, descomentar el método update y las llamadas que se realizan a dicho método
	}
